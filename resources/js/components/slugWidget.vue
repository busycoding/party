...
<template>
  <div class="slug-widget">
    ...
    <div class="url-wrapper wrapper">
      ...
      <!-- v-show - if exists, show the text -->
      <span class="slug" v-show="slug && !isEditing">{{slug}}</span>
      <input type="text" name="slug" class="input" v-show="isEditing" v-model="customSlug"/>
    </div>

    <div class="button-wrapper wrapper">
    <!-- could have done @click="isEditing=!isEditing" -->
    ...
    export default {
      ...
      methods: {
        ...
        editSlug: function() {
          ...
          // emit move from child to parent component
